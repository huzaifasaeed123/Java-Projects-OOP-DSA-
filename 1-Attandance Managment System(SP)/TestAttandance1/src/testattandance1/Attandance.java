...
public class Attandance extends JFrame implements ActionListener
{
    ...
    public  static JCheckBox[] box=new JCheckBox[10];
    ...
    public Attandance(String [] b,String [] c,String date1,String Sec1)
    {
        this.a=b;
        this.reg1=c;
        this.date=date1;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            System.out.println(ex.getMessage());
                    ...
                    JOptionPane.showMessageDialog(null, "Attandance Saved Successfully","File Created",JOptionPane.INFORMATION_MESSAGE);
